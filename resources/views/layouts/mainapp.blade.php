...
<html>
    <head>
        ...
        <link href="{{ asset('assets/css/customstyle.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
    </head>
                    ...
                    <div class="nav-wrapper">
                       ...
                       <ul><li> <span class="textlogo">IMARECON<sup>&reg;</sup> AUTOMATIC QUEUE MANAGEMENT</span></li></ul>
                        ...
                        <ul class="right responsive_disnone hide-on-med-and-down">
                            ...
                            <li><a href="javascript:void(0);" class="ss waves-effect waves-block waves-light translation-button"  data-activates="translation-dropdown"><img src="{{ asset('assets/images/flag-icons/'.$clocale->image) }}" alt="{{ $clocale->name }}" /></a></li>
                            @if(($user->role == 'D')||($user->role == 'S')||($user->role == 'H')||($user->role == 'C')||($user->role == 'U')||($user->role == 'T'))
                        ...
                        <ul id="notifications-dropdown" class="dropdown-content">
                            ...
                            <li><a href="{{ route('displaysecond') }}" target="_blank" style="font-weight:400">{{ trans('messages.mainapp.display_url') }} Second</a></li>
                        ...
                        <?php date_default_timezone_set('Asia/Calcutta');$h = date('H'); $a = $h >= 12 ? 'PM' : 'AM';
                          echo $timestamp = date('h:i:s ').$a; ?>
                           ...
                           <li> <span class="truncate" style="margin-right:20px;font-size:19px">{{ $company_name }}</span></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <footer class="page-footer">
            <div class="footer-copyright">
                <div class="container">
                    ...
                    <span class="right"> <span class="grey-text text-lighten-3">Annual License Version</span> 1.1.2</span>
                </div>
            </div>
        </footer>
        @yield('print')
