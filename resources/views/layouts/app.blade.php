...
@section('menu')
    ...
    <li class="bold{!! Request::is('calls*') ? ' active' : '' !!}"><a href="{{ route('calls') }}" class="waves-effect waves-cyan truncate">
        <i class="mdi-communication-chat"></i> {{ trans('messages.mainapp.menu.token_issue') }}</a>
    </li>
	@endcan
    ...
    @if(($user->role=='U'))  
    <li class=""><a href="{{ route('new_Token') }}" class="waves-effect waves-cyan truncate">
        <i class="mdi-communication-chat"></i> New Token Generate </a>
    </li> 

    <li class=""><a href="{{ route('print_Token') }}" class="waves-effect waves-cyan truncate">
