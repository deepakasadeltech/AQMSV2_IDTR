                        ...
                        <tbody>
                            @foreach($counters as $counter)
                                <tr>
                                    ...
                                    <td>{{ $counter->name }}</td>
                                    <td>{{ $counter->display_sequence }}</td>
                                    <td>@foreach($pdepartments as $pdepartment) @if(($pdepartment->id) == $counter->pid) {{$pdepartment->name}} @endif @endforeach  </td>
                                    <td>@foreach($departments as $department) @if(($department->id) == $counter->department_id) {{$department->name}} @endif @endforeach </td>
                                    <td>
