...
@section('content')
    ...
    <div class="container">
       ...
       @if(count($tokensingle) > 0 ) 
      <div class="input-field col s3">      
      <label>Enter Barcode :</label>
       <input id="autosubmitbarcode" type="text" placeholder="SCAN BARCODE HERE" value="" autocomplete="off" onkeyup="getBarcode(this.value, {{ $tokensingle->id }});" />          
       </div>
       <div class="col s9"> 
      <div id="barcodebox_{{ $tokensingle->id }}">
       </div> </div>
       @else
    ...
    <div class="input-field col s12">      
      <label>Enter Barcode :</label>
       <input class="barcode_{{ $tokendetail->id }}" name="barcode" type="text" placeholder="BARCODE SCAN HERE" value="" autocomplete="off" />          
    </div>     
