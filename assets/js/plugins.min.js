...
//------------------------	
    ...
    null !== e && (e.indeterminate = !0), $(".slider").slider({
        ...
        belowOrigin: !0,
        alignment: "left"
    }), $(".tab-demo").show().tabs(), $(".tab-demo-active").show().tabs(), $(".parallax").parallax(), 
...
$(".toggle-fullscreen_display").click(function() {
      //b();
   }),
$(".toggle-fullscreen").click(function() {
 b();
    ...
    $('.pwdscreen').hide();
	$(".toggle-fullscreen1").click(function() {
        $('.pwdscreen').show();
        var pwdm = 'asadel';
        var pwd = $('.pwdscreen').val();
       if(pwdm == pwd){
        $('.pwdscreen').val('').hide();
        b();
...
$(document).keyup(function(e){
    if(e.which==122){
        e.preventDefault();
        $('.dipbox > .slider > .slides').toggleClass('fullheight');
      $('.dipbox ul.indicators').toggleClass('indicatorht');
      return false;
    }
 });
