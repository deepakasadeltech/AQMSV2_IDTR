        ...
        <div class="col s12">
            <div class="card" style="background:#f9f9f9;box-shadow:none">
                ...
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <a style="margin-bottom:10px;margin-right:5px;text-transform:none" class="waves-effect waves-light btn modal-trigger" href="#modal2_<?php echo e($department->id); ?>"><?php echo e($department->name); ?></a>
...
<li>  <button class="btn waves-effect waves-light csfloat" onclick="queue_dept(<?php echo e($department->id); ?>)" style="text-transform:none"><?php echo e(trans('messages.call.call_next')); ?><i class="mdi-navigation-arrow-forward right"></i>
</button></li>
</ul>
</div>
