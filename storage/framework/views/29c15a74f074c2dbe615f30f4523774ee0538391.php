    ...
    <div class="container">
        <div id="card-stats">
           ...
           <!----------------------------------> 
            ...
            <?php if(($pdepartment->id)==$user_details->department->pid): ?>
            <?php echo e($pdepartment->name); ?>
            ...
            <div class="col s12 m6 l3">
            <div class="doctordetails">
            <span>Sub Department :</span><span><?php echo e($user_details->department->name); ?></span>
            </div></div>

            <div class="col s12 m6 l3">
            <div class="doctordetails">
            <span>Counter :</span><span><?php echo e($user_details->counter->name); ?></span>
            </div></div>
           ...
           <!------------------------------------->
            ...
            <div class="col s12 m6 l3">
              <div class="card hoverable">
                            <div class="card-content pink darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i> Today Patient Called</p>
            ...
            <div class="col s12 m6 l3">
               <div class="card hoverable">
                            <div class="card-content orange darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i>Today Patient In Queue</p>
