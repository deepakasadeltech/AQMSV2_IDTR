        ...
        <div class="row">
            <div class="col s12 m6">
                ...
                <div class="card">
                   ...
                   <a style="margin-bottom:10px;margin-right:5px;text-transform:none" class="waves-effect waves-light btn modal-trigger" href="#modal1_<?php echo e($department->id); ?>"><?php echo e($department->name); ?></a>
...
<li>  <button class="btn waves-effect waves-light csfloat" onclick="call_dept(<?php echo e($department->id); ?>)" style="text-transform:none"><?php echo e(trans('messages.call.call_next')); ?><i class="mdi-navigation-arrow-forward right"></i>
</button></li>
</ul>
   </div>
  ...
  <!--------------------------->
    ...
    <?php if(($user->parent_id)==$department->parent_id): ?>
     <a style="margin-bottom:10px;margin-right:5px;text-transform:none" class="waves-effect waves-light btn modal-trigger" href="#modal1_<?php echo e($department->id); ?>">
...
<div id="printarea" style="background:#f2f2f2; -webkit-print-color-adjust:exact; font-family: 'Open Sans', sans-serif; line-height:1.2;  position:relative;">
   ...
   <span style="display:block; text-transform:uppercase; font-size:14px;"><?php echo e(str_limit( $company_name, 14)); ?></span></h1></td></tr>
   ...
   <tr> <td style="padding:4px; border:1px solid #ccc;">Counter Number <span style="float:right;">:</span></td>  <td style="padding:4px; border:1px solid #ccc;">C-1</td> </tr>
