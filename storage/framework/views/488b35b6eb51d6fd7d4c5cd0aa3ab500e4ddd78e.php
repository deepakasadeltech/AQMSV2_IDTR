                    ...
                    <div class="nav-wrapper">
                       ...
                       <ul><li> <span class="textlogo">IMARECON<sup>&reg;</sup> AUTOMATIC QUEUE MANAGEMENT</span></li></ul>
                        ...
                        <ul class="right responsive_disnone hide-on-med-and-down">
                            ...
                            <?php if(($user->role == 'D')||($user->role == 'S')||($user->role == 'H')||($user->role == 'C')||($user->role == 'U')||($user->role == 'T')): ?>
                        ...
                        <ul id="notifications-dropdown" class="dropdown-content">
                            ...
                            <li><a href="<?php echo e(route('displaysecond')); ?>" target="_blank" style="font-weight:400"><?php echo e(trans('messages.mainapp.display_url')); ?> Second</a></li>
