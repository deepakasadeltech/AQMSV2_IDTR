...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $getpdepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getpdepartment): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>       
    <li class="tab"><a class="<?php if($loop->iteration==1){echo 'active';} ?>" href="#tabname_<?php echo e($getpdepartment->id); ?>"><?php echo e($getpdepartment->name); ?></a></li>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
  </ul>
     
  <?php $__currentLoopData = $getpdepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getpdepartment): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>         
                <div id="tabname_<?php echo e($getpdepartment->id); ?>" class="col s12">
                 <div class="queueblock">
                <table>
                <caption><h3><?php echo e($getpdepartment->name); ?></h3></caption>  
                <thead>
                 <tr><th>Sub Dep</th> <th>Room No.</th> 
                 <th>Doctor</th> 
                 <th>Action</th> </tr>
                </thead>
               <tbody>
               ...
               <?php if($getpdepartment->id==$userdoctordetail->pid): ?>
               <tr>
                 <td><?php echo e($userdoctordetail->department->name); ?></td>
                 <td><?php echo e($userdoctordetail->counter->name); ?></td>
                 <td><?php echo e($userdoctordetail->name); ?></td>
                 <td><a style="margin-bottom:10px;margin-right:5px;text-transform:none" class="waves-effect waves-light btn modal-trigger" href="#modal2_<?php echo e($userdoctordetail->department->id); ?>">TOKEN ISSUE</a></td>  
               </tr>
               <?php endif; ?>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?> 
               </tbody>
               ...
               <!-- <?php $__currentLoopData = $userdoctordetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdoctordetail): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <?php echo e($userdoctordetail->name); ?>

                <?php echo e($userdoctordetail->department->name); ?>

                <?php echo e($userdoctordetail->counter->name); ?>
