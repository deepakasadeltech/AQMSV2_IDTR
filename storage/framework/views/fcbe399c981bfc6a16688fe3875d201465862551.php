...
<h4><?php echo e($department->name); ?> </h4>
      <form id="dep_isuuetkn_<?php echo e($department->id); ?>" name="getValueform_<?php echo e($department->id); ?>" action="<?php echo e(url('queue')); ?>" method="GET">
    <div class = "row">
    <div class="input-field col s12">      
      <label>Enter UID :</label>
       <input class="uhid_<?php echo e($department->id); ?>" name="uhid" type="text" placeholder="UID" value="" autofocus="autofocus" autocomplete="off" onkeyup="getPrioroty(this.value, <?php echo e($department->id); ?>);" />          
    </div>
...
//---------------------------------
var barcodedata = "<?php echo e(session()->get('number')); ?>_<?php echo e(\Carbon\Carbon::now()->format('m-Y')); ?>";
...
var timer = '';
		...
		{  
			...
			timer = setTimeout(function() {
					...
					$.ajax({
						type:"POST",
						url:"<?php echo e(route('post_cuhid')); ?>",
						data:data,
						cache:false,
						beforeSend: function(){
