...
<html>
    <head>
        ...
        <title>Forgot Password | ASADELTECH</title>
    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
                ...
                <form class="login-form" action="<?php echo e(route('post_email')); ?>" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">ASADELTECH</p>
            ...
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="https://www.asadeltech.com" target="_blank" style="color:#ccc">ASADEL TECHNOLOGIES (P) Ltd.</a></span>
            </div>
        </div>
