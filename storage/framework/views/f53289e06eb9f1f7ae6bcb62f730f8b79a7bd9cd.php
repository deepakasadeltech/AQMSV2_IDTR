...
<h4><?php echo e($department->name); ?> <span id="changelg" class="chooselang"> <label> <input name="langk" type="radio" value="hindi"  />
    ...
    <div class="input-field col s12">      
      <label>Veritas UHID :</label>
       <input class="uhid_<?php echo e($department->id); ?> keyboard" name="uhid" type="text" placeholder="UHID" value="" autocomplete="off" onkeyup="getPrioroty(this.value, <?php echo e($department->id); ?>);" />          
    </div>
