...
<div id="tabname_generator" class="col s12"> <table id="generator-table" class="display" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $getusergeneratordetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getgenerator): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($getgenerator->name); ?></td>
                                    <td><?php echo e($getgenerator->username); ?></td>
                                    <td><?php echo e($getgenerator->email); ?></td>
                                    <td><?php if($getgenerator->user_status == 1): ?> Active <?php else: ?> Inactive <?php endif; ?></td>
                                    <td><?php echo e($getgenerator->role_text); ?></td>
                                    <?php if($getgenerator->id==$user->id): ?>
                                        <td>
                                            <a class="btn-floating btn-action waves-effect waves-light orange disabled" href="javascript:void(0);"><i class="mdi-communication-vpn-key"></i></a>
                                            <a class="btn-floating btn-action waves-effect waves-light red disabled" href="javascript:void(0);"><i class="mdi-action-delete"></i></a>
                                        </td>
                                    <?php else: ?>
                                        <td>
                                            <a class="btn-floating btn-action waves-effect waves-light orange tooltipped" href="<?php echo e(route('get_user_password', ['getusergeneratordetails' => $getgenerator->id])); ?>" data-position="top" data-tooltip="<?php echo e(trans('messages.change')); ?> <?php echo e(trans('messages.users.password')); ?>"><i class="mdi-communication-vpn-key"></i></a>
                                            <a class="btn-floating btn-action waves-effect waves-light red tooltipped frmsubmit" href="<?php echo e(route('users.destroy', ['getusergeneratordetails' => $getgenerator->id])); ?>" data-position="top" data-tooltip="<?php echo e(trans('messages.delete')); ?>" method="DELETE"><i class="mdi-action-delete"></i></a>
                                        </td>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
...
<div id="tabname_scanner" class="col s12">
  <table id="scanner-table" class="display" cellspacing="0">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $userscannerdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdoctordetail): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<div id="tabname_courtwork" class="col s12">
  <table id="courtwork-table" class="display" cellspacing="0">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $usercourtworkdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdoctordetail): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<div id="tabname_payfine" class="col s12">
  <table id="payfine-table" class="display" cellspacing="0">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $userpayfinedetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdoctordetail): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
