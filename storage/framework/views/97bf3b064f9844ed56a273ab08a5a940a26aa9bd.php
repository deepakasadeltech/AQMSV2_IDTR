            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1"><img src="<?php echo e(asset('assets/images/dlogo.png')); ?>" alt="asadeltech logo"></a><span class="logo-text">ASADELTECH</span></h1></li>
                        </ul>
                        ...
                        <ul class="right hide-on-med-and-down">
                        <li class="datetimeglobal"><span><?php date_default_timezone_set('Asia/Kolkata'); echo date("l"); ?></span><span><?php date_default_timezone_set('Asia/Kolkata'); echo date("Y.m.d"); ?></span><span id="globaltime"></span></li>
