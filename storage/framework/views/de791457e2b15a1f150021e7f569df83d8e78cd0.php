			...
			<div class="row">
				...
				<div class="card-panel">
                    ...
                    <table id="department-table" class="display" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $patient_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn-floating btn-action waves-effect waves-light orange tooltipped" href="<?php echo e(url('/dashboard/startCounter')); ?>/<?php echo e($patient->id); ?>" data-position="top" data-tooltip="<?php echo e(trans('messages.edit')); ?>"><i class="mdi-editor-mode-edit"></i></a>
										<?php endif; ?>
										
										<?php if($patient->doctor_work_end == 0): ?>
                                        <a class="btn-floating btn-action waves-effect waves-light orange tooltipped" href="<?php echo e(url('/dashboard/endCounter')); ?>/<?php echo e($patient->id); ?>" data-position="top" data-tooltip="<?php echo e(trans('messages.edit')); ?>"><i class="mdi-editor-mode-edit"></i></a>
										<?php endif; ?>
                                    </td>
                                </tr>
