<?php $__env->startSection('title', trans('messages.edit').' '.trans('messages.mainapp.menu.parent_department')); ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 offset-m3" style="padding-top:10px;padding-bottom:10px">
                ...
                <form id="edit" action="<?php echo e(route('parent_departments.update', ['parent_departments' => $department->id])); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input id="name" type="text" name="name" placeholder="<?php echo e(trans('messages.mainapp.menu.parent_department')); ?> <?php echo e(trans('messages.name')); ?>" value="<?php echo e($department->name); ?>" data-error=".name">
                            <div class="name">
