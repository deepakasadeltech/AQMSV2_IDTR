        ...
        <div class="row">
            <div class="col s12 m6 offset-m3" style="padding-top:10px;padding-bottom:10px">
                ...
                <form id="add" action="<?php echo e(route('counters.store')); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <label for="display_sequence"><?php echo e(trans('messages.display_sequence')); ?></label>
                            <input id="display_sequence" type="text" name="display_sequence" placeholder="<?php echo e(trans('messages.display_sequence')); ?>" value="<?php echo e(old('display_sequence')); ?>" data-error=".display_sequence">
