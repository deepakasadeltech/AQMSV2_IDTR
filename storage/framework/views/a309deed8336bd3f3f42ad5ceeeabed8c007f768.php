<?php $__env->startSection('menu'); ?>
    ...
    <li class="bold<?php echo Request::is('calls*') ? ' active' : ''; ?>"><a href="<?php echo e(route('calls')); ?>" class="waves-effect waves-cyan truncate">
        <i class="mdi-communication-chat"></i> <?php echo e(trans('messages.mainapp.menu.token_issue')); ?></a>
    </li>
	<?php endif; ?>
    ...
    <?php if(($user->role=='U')): ?>  
    <li class=""><a href="<?php echo e(route('new_Token')); ?>" class="waves-effect waves-cyan truncate">
        <i class="mdi-communication-chat"></i> New Token Generate </a>
    </li> 

    <li class=""><a href="<?php echo e(route('print_Token')); ?>" class="waves-effect waves-cyan truncate">
        <i class="mdi-communication-chat"></i> Missed Print Token </a>
    </li>                       
    <?php endif; ?>  
