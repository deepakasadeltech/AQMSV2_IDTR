        ...
        <div id="card-stats">
			...
			<div class="row">
					<div class="col s12 m6 l3">
                        <div class="card hoverable">
                            <div class="card-content orange darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i>Today Doctor Present</p>
                    ...
                    <div class="col s12 m6 l3">
                        <div class="card hoverable">
                            <div class="card-content light-green darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i>Today Doctor Absent</p>
                                <h4 class="card-stats-number">0</h4>
                                </p>
                            </div>
                ...
                <div class="row">
            <div class="col s12">
            <h3 class="listdoctor">List Of Doctor</h3>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tuser): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr<?php echo ($tuser->id==$user->id)?' class="orange lighten-4"':''; ?>>
                                  ...
                                  <td class="caction">
                                  <button type="submit" class="btn waves-effect waves-light btn-small green">Present</button>
                                  <button type="submit" class="btn waves-effect waves-light btn-small pink">Absent</button>
                                 </td>
           ...
           <?php if($pdepartments->id == ''): ?> <a style="color:red">Not Allotted</a>  <?php else: ?> <?php echo e($pdepartments->name); ?>  <?php endif; ?>
            ...
            <div class="col s12 m6 l3">
            <div class="doctordetails">
            <span>Counter :</span><span><?php if($user_details->counter_id == ''): ?> <a style="color:red">Not Allotted</a> <?php else: ?> <?php echo e($user_details->counter->name); ?>  <?php endif; ?></span>
            </div></div>
           ...
           <!------------------------------------->
            ...
            <!---------------------->
             <div class="col s12 m6 l3">
              <div class="card hoverable">
                            <div class="card-content light-green darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i>Today Patient Seen By You </p>
            ...
            <div class="col s12 m6 l3">
              <div class="card hoverable">
                            <div class="card-content pink darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i> Today Patient Called By You</p>
            ...
            <div class="col s12 m6 l3">
               <div class="card hoverable">
                            <div class="card-content orange darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i>Today Overall Patient In Queue</p>
            ...
            <div class="col s12 m6 l3">
                        <div class="card hoverable">
                            <div class="card-content blue darken-2 white-text">
                                <p class="card-stats-title truncate"><i class="mdi-social-group-add"></i> Doctor Average Time (Today)</p>
                                <h4 class="card-stats-number">
